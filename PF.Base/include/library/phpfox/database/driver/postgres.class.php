 ...
 * @package 		Phpfox
 * @version 		$Id: postgres.class.php 1666 2010-07-07 08:17:00Z phpFox LLC $
 */
class Phpfox_Database_Driver_Postgres extends Phpfox_Database_Driver_Mysqli
{
    ...
    {
        // remove ROW_FORMAT=DYNAMIC (it added from to hot fix innodb_large_prefix = 1 and innodb_file_format=barracuda, innodb_file_per_table=true
        $sSql = str_replace(' ROW_FORMAT=DYNAMIC;', '', $sSql);
		if (!$hLink)
		{
			$hLink =& $this->_hMaster;	
		}
