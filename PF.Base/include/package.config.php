...
return [
    'services' => [
        ...
        'parse.linkify'              => \Phpfox_Parse_Linkify::class,
        ...
        'location.gmap'              => \Phpfox_Location_Gmap::class,
		'session.manager'            => \Core\Session\SessionManager::class,
		'session.admincp'            => \Core\Session\Admincp::class,
		'storage'                    => \Core\Storage\StorageManager::class,
		'storage.admincp'            => \Core\Storage\Admincp::class,
		'assets'                     => \Core\Assets\Manager::class,
		'log.admincp'                => \Core\Log\Admincp::class,
		'logger'                     => \Core\Log\Admincp::class,
		'job.manager'                => [\Phpfox_Queue::class, null],
        'job.admincp'                => \Core\Queue\Admincp::class,
		'sms'                		 => [\Core\SMS\SmsManager::class, null],
		'sms.admincp'                => [\Core\SMS\Admincp::class, null],
    ],
];