                            ...
                            <td class="widget-actions">
                                ...
                                <div class="dropdown core-page-table-action">
                                    ...
                                    <ul role="menu" class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <li class="item_delete">
                                            <a href="#" onclick="$Core.jsConfirm({l}{r}, function(){l} $.ajaxCall('pages.deleteWidget', 'widget_id={$aPageMenu.widget_id}'); {r}, function(){l}{r}); return false;"><span class="ico ico-trash-o mr-1"></span> {_p var='delete'}</a>
                                        </li>
                                    </ul>
                                </div>
                                {/if}
