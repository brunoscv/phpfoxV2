                            ...
                            <div class="item-outer">
                                ...
                                <div class="page-photo">
                                    ...
                                    <a class="item-desc" href="{$aPage.link}">
                                        <div class="item-desc-main">{$aPage.text_parsed|striptag|stripbb|clean}</div>
                                    </a>
                                </div>
                                ...
                                <div class="item-inner">
                                    <div class="item-title">
                                        <span class="user_profile_link_span" id="js_user_name_link_{if !empty($aPage.profile_user_id)}{$aPage.profile_user_id}{/if}">
    ...
    <article class="page-item" data-url="{$aPage.url}" data-uid="pages_{$aPage.page_id}" id="pages_{$aPage.page_id}">
        <div class="item-outer">
            ...
            <a class="page-photo" href="{$aPage.url}">
                {img server_id=$aPage.profile_server_id title=$aPage.title path='pages.url_image' file=$aPage.image_path suffix='_200_square' fallback_suffix='_200' max_width='200' max_height='200' is_page_image=true}
