...
<div class="page-block-action block">
    <div class="item-inner">
        ...
        {else}
        <a href="#" class="btn btn-round btn-icon btn-default btn-sm pages_like_join" onclick="$(this).remove(); {if $aPage.reg_method == '1' && !isset($aPage.is_invited)} $.ajaxCall('groups.signup', 'page_id={$aPage.page_id}'); {else}$.ajaxCall('like.add', 'type_id=pages&amp;item_id={$aPage.page_id}&amp;reload=1');{/if} return false;">
