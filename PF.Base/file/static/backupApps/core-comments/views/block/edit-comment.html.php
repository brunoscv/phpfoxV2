    ...
    <form method="post" action="#" class="js_app_comment_feed_form form" data-edit-id="{$aComment.comment_id}">
        <div class="item-edit-content">
            <div class="item-box-input">
                ...
                <textarea rows="1" name="val[text]" class="form-control comment-textarea-edit js_comment_textarea_edit" id="js_comment_quick_edit_{$aComment.comment_id}" placeholder="{if $aComment.parent_id}{_p var='write_a_reply'}{else}{_p var='write_a_comment'}{/if}">{$aComment.text}</textarea>
