                            ...
                            {if $aFeed.can_share}
                                <div class="feed-comment-share-holder">
                                    ...
                                    {if $aFeed.privacy == '0' || $aFeed.privacy == '1' || $aFeed.privacy == '2'}
                                        ...
                                        {else}
                                            {module name='share.link' type='feed' display='menu_btn' url=$aFeed.feed_link title=$aFeed.feed_title sharefeedid=$aFeed.item_id sharemodule=$aFeed.comment_type_id}
                                        {/if}
                                    {else}
                                                                ...
                                                                <div class="comment-box js_comment_box">
                                                                    <div class="item-edit-content">
                                                                        <div class="item-box-input">
                                                                            <textarea rows="1" name="val[text]" class="form-control comment-textarea-edit js_app_comment_feed_textarea" id="js_feed_comment_form_textarea_{$aFeed.feed_id}" placeholder="{_p var='write_a_comment'}" autocomplete="off"></textarea>
                                                                            ...
                                                                            <div class="comment-group-icon dropup js_comment_group_icon">
                                                                                ...
                                                                                {if !empty(Phpfox::getService('comment.stickers')->countActiveStickerSet())}
