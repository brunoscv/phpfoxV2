    ...
    <div class="core-activitypoint-statistic">
        <div class="statistic-wrapper-left">
            <div class="item-statistic-with-icon">
                ...
                <div class="item-inner">
                    <div class="item-title">{$aStatistics.current_points.title}<span class="ico ico-question-circle " data-toggle="tooltip" data-placement="top" title="{_p var='activitypoint_current_points_information'}"></span></div>
                    <div class="item-number">{$aStatistics.current_points.points|number_format}</div>
                </div>
            </div>
            <div class="statistic-list-mini">
                <div class="item-list-title">
                    <div class="item-title">{$aStatistics.earned_points.title}<span class="ico ico-question-circle" data-toggle="tooltip" data-placement="top" title="{_p var='activitypoint_total_earned_information'}"></span></div>
                    <div class="item-title">{$aStatistics.bought_points.title}<span class="ico ico-question-circle" data-toggle="tooltip" data-placement="top" title="{_p var='activitypoint_total_bought_information'}"></span></div>
                    <div class="item-title">{$aStatistics.received_points.title}<span class="ico ico-question-circle" data-toggle="tooltip" data-placement="top" title="{_p var='activitypoint_total_received_information'}"></span></div>
                    <div class="item-title">{$aStatistics.retrieved_points.title}<span class="ico ico-question-circle" data-toggle="tooltip" data-placement="top" title="{_p var='activitypoint_total_retrieved_information'}"></span></div>
                </div>
        ...
        <div class="statistic-wrapper-right">
            <div class="item-statistic-with-icon">
                ...
                <div class="item-inner">
                    <div class="item-title">{$aStatistics.spent_points.title}<span class="ico ico-question-circle" data-toggle="tooltip" data-placement="top" title="{_p var='activitypoint_total_spent_information'}"></span></div>
            ...
            <div class="item-statistic-with-icon">
                ...
                <div class="item-inner">
                    <div class="item-title">{$aStatistics.sent_points.title}<span class="ico ico-question-circle" data-toggle="tooltip" data-placement="top" title="{_p var='activitypoint_total_sent_information'}"></span></div>
