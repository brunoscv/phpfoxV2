...
<?php if ($this->_aVars['iShownTotal'] < $this->_aVars['aFeed']['total_comment']): ?>
            <div class="core_comment_viemore_holder">
                <div class="comment-viewmore" id="js_feed_comment_pager_<?php echo $this->_aVars['aFeed']['comment_type_id']; ?>_<?php echo $this->_aVars['aFeed']['item_id']; ?>">
                    <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('comment.comments'); ?>?type=<?php echo $this->_aVars['aFeed']['comment_type_id']; ?>&id=<?php echo $this->_aVars['aFeed']['item_id']; ?>&page=1<?php if (defined ( 'PHPFOX_FEED_STREAM_MODE' )): ?>&stream-mode=1<?php endif; ?>&time-stamp=<?php echo $this->_aVars['aFeed']['comments']['0']['time_stamp']; ?>&shown-total=<?php echo $this->_aVars['iShownTotal']; ?>&total-comment=<?php echo $this->_aVars['aFeed']['total_comment']; ?>" class="item-viewmore ajax" onclick="$(this).addClass('active');">
...
<?php else: ?>
<?php Phpfox::getBlock('share.link', array('type' => 'feed','display' => 'menu_btn','url' => $this->_aVars['aFeed']['feed_link'],'title' => $this->_aVars['aFeed']['feed_title'],'sharefeedid' => $this->_aVars['aFeed']['item_id'],'sharemodule' => $this->_aVars['aFeed']['comment_type_id'])); ?>
<?php endif; ?>
<?php else: ?>
                                    ...
                                    <div class="comment-box-container">
                                        <div class="js_feed_core_comment_form" <?php if (isset ( $this->_aVars['sFeedType'] ) && $this->_aVars['sFeedType'] == 'view'): ?> id="js_feed_comment_form_<?php echo $this->_aVars['aFeed']['feed_id']; ?>"<?php endif; ?>>
                                            ...
                                            <div class="<?php if (isset ( $this->_aVars['sFeedType'] ) && $this->_aVars['sFeedType'] == 'view'): ?> feed_item_view<?php endif; ?>">
                                                <form method="post" action="#" class="js_app_comment_feed_form form">
                                                                ...
                                                                <div class="comment-box js_comment_box">
                                                                    <div class="item-edit-content">
                                                                        <div class="item-box-input">
                                                                            <textarea rows="1" name="val[text]" class="form-control comment-textarea-edit js_app_comment_feed_textarea" id="js_feed_comment_form_textarea_<?php echo $this->_aVars['aFeed']['feed_id']; ?>" placeholder="<?php echo _p('write_a_comment'); ?>" autocomplete="off"></textarea>
...
<?php if (! empty ( Phpfox ::getService('comment.stickers')->countActiveStickerSet())): ?>
