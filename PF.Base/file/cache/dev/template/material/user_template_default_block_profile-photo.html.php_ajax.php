...
<div id="thumbnail" class="tab-pane fade in active">
    <div id="profile_crop_me">
        <div class="image-editor">
            ...
            <form method="post" action="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('user.photo.process'); ?>" dir="ltr" id="update-profile-image-form">
<?php Phpfox::getBlock('core.upload-form', array('type' => 'user')); ?>
                <div class="cropit-preview"></div>
                <div class="cropit-drag-info"><span><?php echo _p('drag_to_reposition_photo'); ?></span></div>
        ...
        <div class="rotate_button">
            <a role="button" class="btn btn-default" onclick="$Core.ProfilePhoto.update(false)"><?php echo _p('change_photo'); ?></a>
            <input type="button" class="btn btn-primary" value='<?php echo _p("Save"); ?>' onclick="$Core.ProfilePhoto.save()"/>
        </div>
    </div>
</div>
