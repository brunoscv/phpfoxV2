...
<?php echo _p('no_photos_uploaded_yet'); ?>
    </div>
<?php else: ?>
    <div class="item-container photo-widget-block recent-photo photo-app">
<?php if (count((array)$this->_aVars['aPhotos'])):  foreach ((array) $this->_aVars['aPhotos'] as $this->_aVars['aPhoto']): ?>
            <article class="photos-<?php echo $this->_aVars['iCount']; ?>">
                <div class="item-outer">
                    <a class="item-media <?php if (! $this->_aVars['aPhoto']['can_view']): ?>photo-mature<?php endif; ?>" <?php if (! $this->_aVars['aPhoto']['can_view']): ?>onclick="tb_show('<?php echo _p('warning'); ?>', $.ajaxBox('photo.warning', 'height=300&width=350&link=<?php echo $this->_aVars['aPhoto']['link']; ?>')); return false;" href="javascript:;"<?php else: ?>href="<?php echo $this->_aVars['aPhoto']['link']; ?>"<?php endif; ?> title="<?php echo _p('title_by_full_name', array('title' => Phpfox::getLib('phpfox.parse.output')->cleanPhrases(Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aPhoto']['title'])),'full_name' => Phpfox::getLib('phpfox.parse.output')->cleanPhrases(Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aPhoto']['full_name'])))); ?>" <?php if (! empty ( $this->_aVars['aPhoto']['destination'] )): ?>style="background-image: url(<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('server_id' => $this->_aVars['aPhoto']['server_id'],'path' => 'photo.url_photo','file' => $this->_aVars['aPhoto']['destination'],'suffix' => '_500','max_width' => 500,'max_height' => 500,'class' => "hover_action",'title' => $this->_aVars['aPhoto']['title'],'return_url' => true)); ?>)"<?php endif; ?>>
                    </a>
<?php if ($this->_aVars['aPhoto']['total_like'] > 0): ?>
                        <div class="item-statistic">
                            <span class="like-count"><i class="ico ico-thumbup mr-1"></i><?php echo Phpfox::getService('core.helper')->shortNumber($this->_aVars['aPhoto']['total_like']); ?></span>
                        </div>
<?php endif; ?>
                </div>
            </article>
