...
<?php echo _p('friend_requests'); ?>
            ...
            <div class="dropdown-panel-body" id="request-panel-body"></div>
             <div class="dropdown-panel-footer" id="request-panel-footer">
                 <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('friend.accept'); ?>" id="js_view_all_requests"></a>
             </div>
        </div>
    </li>
...
<?php echo _p('mark_all_read'); ?>
                ...
                <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('mail'); ?>"><?php echo _p('view_all_messages'); ?></a>
             </div>
        </div>
    </li>
    <li class="mr-2" id="hd-notification">
        ...
        <div class="dropdown-panel">
            ...
            <div class="dropdown-panel-footer">
                <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('notification'); ?>"><?php echo _p('view_all_notifications'); ?></a>
            </div>
        </div>
    </li>
<?php endif; ?>
...
<?php if (Phpfox ::getUserBy('profile_page_id') > 0): ?>
        <ul class="dropdown-menu dropdown-menu-right dont-unbind">
            <li class="background-cover-block">
                ...
                <div class="edit-page">
                    <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('pages.add', array('id' => $this->_aVars['iGlobalProfilePageId'])); ?>" class="s-4 btn-gradient btn-primary">
...
<?php endif; ?>
                ...
                <div class="edit-profile">
                    <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('user.profile'); ?>" title="<?php echo _p('edit_profile'); ?>" class="no_ajax s-4 btn-primary btn-gradient">
                        <i class="ico ico-pencilline-o"></i>
                    </a>
                </div>
            </li>
...
<?php if (Phpfox ::isAdmin()): ?>
                <li role="presentation">
                    <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('admincp'); ?>" target="_blank" class="no_ajax">
...
<?php if (Phpfox ::getParam('user.allow_user_registration') && ! Phpfox ::getParam('user.invite_only_community')): ?>
    <a class="btn btn-sm btn-default <?php if (Phpfox ::canOpenPopup('user.register')): ?>popup<?php else: ?>no_ajax<?php endif; ?>"
       rel="hide_box_title visitor_form" role="link" href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('user.register'); ?>">
<?php echo _p('sign_up'); ?>
    </a>
<?php endif; ?>
    <a class="btn btn-sm btn-success btn-gradient <?php if (Phpfox ::canOpenPopup('login')): ?>popup<?php else: ?>no_ajax<?php endif; ?>"
       rel="hide_box_title visitor_form" role="link" href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('login'); ?>">
<?php echo _p('sign_in'); ?>
    </a>
</div>
<?php endif; ?>
