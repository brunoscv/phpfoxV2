...
<?php /* Cached: September 11, 2020, 8:10 pm */ ?>
<?php



 if (! empty ( $this->_aVars['sCreateJs'] )): ?>
<?php echo $this->_aVars['sCreateJs'];  endif;  (($sPlugin = Phpfox_Plugin::get('user.template_controller_login_block__start')) ? eval($sPlugin) : false); ?>
