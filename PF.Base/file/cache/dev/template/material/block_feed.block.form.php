...
<?php endif; ?>
      <div class="activity_feed_form_holder">
        ...
        <div class="global_attachment_holder_section" id="global_attachment_status" style="display:block;">
          ...
          <textarea <?php if (isset ( $this->_aVars['aPage'] )): ?> id="pageFeedTextarea" <?php else: ?> <?php if (isset ( $this->_aVars['aEvent'] )): ?> id="eventFeedTextarea" <?php else: ?> <?php if (isset ( $this->_aVars['bOwnProfile'] ) && $this->_aVars['bOwnProfile'] == false): ?>id="profileFeedTextarea" <?php endif;  endif;  endif; ?> cols="60" rows="2" name="val[user_status]" placeholder="<?php if (isset ( $this->_aVars['aFeedCallback']['module'] ) || defined ( 'PHPFOX_IS_USER_PROFILE' )):  echo _p('write_something');  else:  echo _p('what_s_on_your_mind');  endif; ?>" class="close_warning <?php if (Phpfox ::isModule('egift')): ?>textarea-has-egift<?php endif; ?>" ></textarea>
        </div>
