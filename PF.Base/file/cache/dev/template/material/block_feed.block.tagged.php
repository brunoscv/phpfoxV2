    ...
    <div class="js_feed_compose_extra feed_compose_extra js_feed_compose_tagging dont-unbind-children" style="display: none;">
        <div class="feed-box">
            ...
            <div class="feed-tagging-input-box">
                <input type="hidden" data-feedid = "<?php if (isset ( $this->_aVars['iFeedId'] )):  echo $this->_aVars['iFeedId'];  else: ?>0<?php endif; ?>" id="feed_input_tagged<?php if (isset ( $this->_aVars['iFeedId'] )): ?>_<?php echo $this->_aVars['iFeedId'];  else: ?>_0<?php endif; ?>" name="val[tagged_friends]" value="<?php if (isset ( $this->_aVars['aForms']['tagged_friends'] )):  echo $this->_aVars['aForms']['tagged_friends'];  endif; ?>">
