...
<?php /* Cached: September 25, 2020, 1:44 pm */ ?>
<?php
...
<?php echo _p('ssitetitle_is_an_invite_only_community_enter_your_email_below_if_you_have_received_an_invitation', array('sSiteTitle' => $this->_aVars['sSiteTitle'])); ?>
            ...
            <form method="post" class="form" action="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('user.register'); ?>">
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">
                            <span class="ico ico-at-sign"></span>
                        </div>
                        <input type="text" id="invite_email" class="form-control" placeholder="<?php echo _p('your_email'); ?>" name="val[invite_email]" value="" />
                    </div>
                </div>
...
<?php if (Phpfox ::getParam('user.allow_user_registration')): ?>
            <div id="js_registration_holder">
                <form method="post" class="form" action="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('user.register'); ?>" id="js_form" enctype="multipart/form-data" data-step="1">
...
<?php else: ?>
                                <a class="keepPopup" rel="hide_box_title visitor_form" href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('login'); ?>"><?php echo _p('sign_in_now'); ?></a>
<?php endif; ?>
                        </div>
                    </div>
