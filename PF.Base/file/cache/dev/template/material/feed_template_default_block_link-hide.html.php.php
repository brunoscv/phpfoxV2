...
?>
<?php if (Phpfox ::getUserId() && ( Phpfox ::getUserId() != $this->_aVars['aFeed']['user_id'] ) && empty ( $this->_aVars['aFeed']['feed_display'] ) && ! defined ( 'PHPFOX_IS_USER_PROFILE' ) && ! defined ( 'PHPFOX_IS_PAGES_VIEW' ) && ! defined ( 'PHPFOX_IS_EVENT_VIEW' )): ?>
