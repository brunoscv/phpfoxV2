...
<span class="field_separator"> / </span><?php $aYears = range($this->_aVars['sDobEnd'], $this->_aVars['sDobStart']);   $aParams = (isset($aParams) ? $aParams : Phpfox::getLib('phpfox.request')->getArray('val')); ?>		<select name="val[year]" id="year" class="form-control js_datepicker_year">
...
<?php if (Phpfox ::getParam('user.force_user_to_upload_on_sign_up')): ?>
	<div class="form-group register-upload-photo">
		*<label class=""><?php echo _p('profile_image'); ?></label>
		<input type="file" name="image" accept="image/*"/>
		<p class="help-block">
<?php echo _p('you_can_upload_a_jpg_gif_or_png_file'); ?>
		</p>
	</div>
<?php endif; ?>
