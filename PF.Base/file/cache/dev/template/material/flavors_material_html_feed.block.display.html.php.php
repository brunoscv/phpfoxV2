...
<?php if (Phpfox ::isUser() && ! defined ( 'FEED_LOAD_MORE_NEWS' ) && ! defined ( 'FEED_LOAD_NEW_FEEDS' ) && ( ! isset ( $this->_aVars['bIsGroupMember'] ) || $this->_aVars['bIsGroupMember'] ) && ! ( isset ( $this->_aVars['aFeedCallback']['disable_share'] ) && $this->_aVars['aFeedCallback']['disable_share'] )): ?>
  <?php
...
<?php if (count ( $this->_aVars['aFeeds'] ) > 8): ?>
    <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('hashtag');  echo $this->_aVars['sIsHashTagSearch']; ?>/page_1/" class="global_view_more no_ajax_link btn btn-primary btn-round btn-gradient" style="display:block;"><?php echo _p('load_more'); ?></a>
<?php endif; ?>
<?php else: ?>
