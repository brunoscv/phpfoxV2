...
<?php (($sPlugin = Phpfox_Plugin::get('core.gmap_block_start')) ? eval($sPlugin) : false); ?>
    <div class="item-block-wrapper" style="background-image: url(<?php echo $this->_aVars['sImage']; ?>)">
        <a href="<?php echo $this->_aVars['sUrl']; ?>" class="no_ajax btn btn-sm btn-primary"><?php echo _p('view_on_map'); ?></a>
    </div>
<?php (($sPlugin = Phpfox_Plugin::get('core.gmap_block_end')) ? eval($sPlugin) : false); ?>
</div>
