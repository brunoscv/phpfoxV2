...
<?php if (Phpfox ::isModule('report') && isset ( $this->_aVars['sFeedType'] ) && isset ( $this->_aVars['aFeed']['report_module'] ) && ! User_Service_Block_Block ::instance()->isBlocked(null, $this->_aVars['aFeed']['user_id'] )): ?>
...
<?php if (! empty ( $this->_aVars['feed_entry_be'] ) && ( defined ( 'PHPFOX_FEED_CAN_DELETE' ) || ( Phpfox ::getUserParam('feed.can_delete_own_feed') && $this->_aVars['aFeed']['user_id'] == Phpfox ::getUserId()) || Phpfox ::getUserParam('feed.can_delete_other_feeds') || ( ! defined ( 'PHPFOX_IS_PAGES_VIEW' ) && ! empty ( $this->_aVars['aFeed']['parent_user_id'] ) && ( int ) $this->_aVars['aFeed']['parent_user_id'] === Phpfox ::getUserId()))): ?>
        <li class="item-delete"><a href="#" class="" onclick="$Core.jsConfirm({}, function(){$.ajaxCall('feed.delete', 'height=400&amp;width=600&amp;TB_inline=1&amp;call=feed.delete&amp;type=delete&amp;id=<?php echo $this->_aVars['aFeed']['feed_id'];  if (isset ( $this->_aVars['aFeedCallback']['module'] )): ?>&amp;module=<?php echo $this->_aVars['aFeedCallback']['module']; ?>&amp;item=<?php echo $this->_aVars['aFeedCallback']['item_id'];  endif; ?>&amp;type_id=<?php echo $this->_aVars['aFeed']['type_id']; ?>')}, function(){}); return false;">
