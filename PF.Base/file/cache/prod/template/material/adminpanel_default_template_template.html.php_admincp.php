            ...
            <div class="admincp_right_group">
                <div class="admincp_alert dropdown">
                    <a data-toggle="dropdown" role="button" id="js_admincp_alert" data-panel="#js_admincp_alert_panel">
                        <div class="ajax" data-url="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('admincp.alert.badge'); ?>"></div>
...
<?php if (! Phpfox ::demoModeActive()): ?>
                <div class="admincp_view_site">
                    <a target="_blank" href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl(''); ?>"><span class="item-text"><?php echo _p('view_site'); ?>&nbsp;</span><i class="fas fa fa-external-link"></i></a>
                </div>
<?php endif; ?>
            </div>
...
<?php if (isset ( $this->_aVars['sLink']['items'] ) && ! empty ( $this->_aVars['sLink']['items'] )): ?>class="item-header <?php if (isset ( $this->_aVars['sLink']['is_active'] )): ?>is_active<?php endif; ?>" data-cmd="admincp.open_sub_menu"<?php else:  if (isset ( $this->_aVars['sLink']['is_active'] )): ?>class="is_active"<?php endif;  endif; ?>>
...
<?php if (count((array)$this->_aVars['sLink']['items'])):  foreach ((array) $this->_aVars['sLink']['items'] as $this->_aVars['sLink2']): ?>
                                    <li><a data-tags="<?php if (isset ( $this->_aVars['sLink2']['tags'] )):  echo $this->_aVars['sLink2']['tags'];  endif; ?>" href="<?php echo $this->_aVars['sLink2']['link']; ?>" class="<?php if (isset ( $this->_aVars['sLink2']['class'] )):  echo $this->_aVars['sLink2']['class'];  endif;  if (isset ( $this->_aVars['sLink2']['is_active'] )): ?>is_active<?php endif; ?>"><?php if (! empty ( $this->_aVars['sLink2']['icon'] )): ?><i class="<?php echo $this->_aVars['sLink2']['icon']; ?>"></i><?php endif;  echo $this->_aVars['sLink2']['label']; ?></a></li>
...
<?php endforeach; endif; ?>
            ...
            <div id="global_remove_site_cache_item">
                <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('admincp.maintain.cache', array('all' => 1,'return' => $this->_aVars['sCacheReturnUrl'])); ?>">
...
<?php if ($this->_aVars['bEnableBundle']): ?>
            <div id="global_remove_site_cache_item">
                <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('admincp.maintain.bundle', array('all' => 1,'return' => $this->_aVars['sCacheReturnUrl'])); ?>">
...
<?php if (count((array)$this->_aVars['aSectionAppMenus'])):  foreach ((array) $this->_aVars['aSectionAppMenus'] as $this->_aVars['sPhrase'] => $this->_aVars['aMenu']): ?>
                                    <a <?php if (isset ( $this->_aVars['aMenu']['cmd'] )): ?>data-cmd="<?php echo $this->_aVars['aMenu']['cmd']; ?>"<?php endif; ?>  href="<?php if (( substr ( $this->_aVars['aMenu']['url'] , 0 , 1 ) == '#' )):  echo $this->_aVars['aMenu']['url'];  else:  echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aMenu']['url']);  endif; ?>"
...
<?php if (!$this->bIsSample): ?><div id="site_content"><?php if (isset($this->_aVars['bSearchFailed'])): ?><div class="message">Unable to find anything with your search criteria.</div><?php else:  $sController = "admincp.setting/edit";  Phpfox::getLib('phpfox.module')->getControllerTemplate();  endif; ?></div><?php endif; ?>
                        </div>
