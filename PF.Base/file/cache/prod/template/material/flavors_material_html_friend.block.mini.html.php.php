...
$Behavior.setTimeoutFriends = function(){
	setTimeout('$.ajaxCall(\'friend.getOnlineFriends\', \'\', \'GET\')', 1000);
	$Behavior.setTimeoutFriends = function(){}
}
</script>
<?php else:  if (count ( $this->_aVars['aFriends'] )): ?>
...
<?php if (( $this->_aVars['redis_enabled'] )): ?>
<?php echo $this->_aVars['aFriend']['photo_link']; ?>
<?php else: ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aFriend'],'suffix' => '_50_square','max_width' => 50,'max_height' => 50,'class' => 'js_hover_title')); ?>
<?php endif; ?>
		</div>
	</li>	
<?php endforeach; endif; ?>
<?php if ($this->_aVars['iRemainCount'] > 0): ?>
	<li class="user_rows view-friend-more">
		<a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('profile.friend', array('view' => 'online')); ?>">+<?php echo $this->_aVars['iRemainCount']; ?></a>
	</li>
<?php endif; ?>
</ul>
<?php else: ?>
<div class="extra_info">
<?php echo _p('no_friends_online'); ?>
</div>
<?php endif;  endif; ?>
