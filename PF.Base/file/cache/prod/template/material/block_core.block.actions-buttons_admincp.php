...
<?php if (count ( $this->_aVars['aSubMenus'] ) == 1 && empty ( $this->_aVars['aCustomMenus'] ) && ( $this->_aVars['aSubMenu'] = reset ( $this->_aVars['aSubMenus'] ) )): ?>
        <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aSubMenu']['url']); ?>" class="btn btn-success btn-gradient js_hover_title <?php if (! empty ( $this->_aVars['aSubMenu']['css_name'] )):  echo $this->_aVars['aSubMenu']['css_name'];  endif; ?>">
...
<?php if (isset ( $this->_aVars['aSubMenu']['module'] ) && ( isset ( $this->_aVars['aSubMenu']['var_name'] ) || isset ( $this->_aVars['aSubMenu']['text'] ) )): ?>
                <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aSubMenu']['url']); ?>"<?php if (( isset ( $this->_aVars['aSubMenu']['css_name'] ) )): ?> class="<?php echo $this->_aVars['aSubMenu']['css_name']; ?> no_ajax"<?php else: ?>class=""<?php endif; ?>>
