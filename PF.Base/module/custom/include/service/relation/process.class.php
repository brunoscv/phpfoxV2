...
class Custom_Service_Relation_Process extends Phpfox_Service
{
    ...
    public function updateRelationship($iRelationType, $iWith = null, $iUser = null, $iRelationDataId = null)
    {
        ...
        if (!empty($aExisting['relation_data_id']) && $aExisting['status_id'] == 1) {
            ...
            Phpfox::getLib('mail')->to([$iUser])
                ...
                ->message([
                    ...
                    [
                        ...
                        'phrase_var_name' => _p($aExisting['phrase_var_name'])
                    ]
                ])
                ->send();
            ...
            /* Add the feed */
            (Phpfox::isModule('feed') ? Phpfox::getService('feed.process')->add('custom_relation', $iNewRelationId, 0, 0, 0, $aExisting['with_user_id'], $aExisting['crd_user_id']) : null);
        ...
        /* Add the feed */
        (Phpfox::isModule('feed') ? Phpfox::getService('feed.process')->add('custom_relation', $aExisting['relation_data_id'], 0, 0, 0, $iUser) : null);
