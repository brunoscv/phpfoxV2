        ...
        if (isset($aVals['feed_id'])) {
            ...
            if (!empty($feed)) {
                ...
                if (!empty($this->_bIsCallback) && $feedType == $feedCommentType) {
                    ...
                    Phpfox::getService('feed.tag')->notifyTaggedInFeed($feedType, $sStatus, $iStatusId, $ownerId, $feedId, $aTagged, $aVals['privacy'], $aVals['parent_user_id'], $oldTagged, $oldMentions, ($this->_aCallback['module'] ? $this->_aCallback['module'] : ''));
                    if (Phpfox::isModule('tag') && Phpfox::getParam('tag.enable_hashtag_support')) {
            ...
            if (!isset($aVals['feed_reference']) || empty($aVals['feed_reference'])) {
                ...
                if (isset($aVals['feed_type'])) {
                    ...
                    // notification to tagged and mentioned friends
                    Phpfox::getService('feed.tag')->notifyTaggedInFeed($aVals['feed_type'], $sStatus, $iStatusId, $ownerId, $feedId, $aTagged, $aVals['privacy'], (isset($aVals['parent_user_id']) ? (int)$aVals['parent_user_id'] : 0));
                    return $feedId;
                }
                ...
                // notification to tagged and mentioned friends
                Phpfox::getService('feed.tag')->notifyTaggedInFeed($feedType, $sStatus, $iStatusId, $ownerId, $feedId, $aTagged, $aVals['privacy'], (isset($aVals['parent_user_id']) ? (int)$aVals['parent_user_id'] : 0));
                return $feedId;
            }
