...
class Admincp_Service_Setting_Setting extends Phpfox_Service
{
    ...
    public function get($aCond = [])
    {
        ...
        foreach ($aRows as $iKey => $aRow) {
            ...
            } elseif ($aRow['var_name'] == 'captcha_font') {
            ...
            } elseif ($aRow['var_name'] == 'default_time_zone_offset') {
                $aRows[$iKey]['type_id'] = 'drop_with_key';
                $aRows[$iKey]['values'] = $aTimezones;
            } elseif ($aRow['var_name'] == 'ip_check') {
                $aIpCheck = [
                    '0' => '255.255.255.255',
                    '1' => '255.255.255.0',
                    '2' => '255.255.0.0'
            ...
            } elseif ($aRow['var_name'] == 'activity_points_conversion_rate') {
                $aValueActuals = [];
                if (!empty($aRow['value_actual'])) {
