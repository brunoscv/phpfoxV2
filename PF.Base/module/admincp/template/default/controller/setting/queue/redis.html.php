    ...
    <div id="client_details" class="panel panel-default">
        <div class="panel-body">
            <div>
                ...
                <div class="form-group">
                    <label for="redis_database_index">{_p var='redis_database_number'}</label>
                    <input id="redis_database_index" type="number" class="form-control" min="0" max="15" placeholder="{_p var='redis_database_number'}" value="{value type='input' id='database_index'}" name="val[database_index]">
                </div>
                <div class="form-group">
