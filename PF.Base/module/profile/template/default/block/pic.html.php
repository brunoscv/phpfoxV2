	...
	<div class="profiles_banner_bg">
        ...
        <a href="{permalink module='photo' id=$aCoverPhoto.photo_id title=$aCoverPhoto.title}">
            ...
            <div class="cover" id="cover_bg_container">
                {img server_id=$aCoverPhoto.server_id path='photo.url_photo' file=$aCoverPhoto.destination suffix='' class="visible-md visible-lg cover_photo"}
                {img server_id=$aCoverPhoto.server_id path='photo.url_photo' file=$aCoverPhoto.destination suffix='' class="hidden-md hidden-lg"}
            </div>
        </a>
        <div class="cover-reposition-actions">
            <a role="button" class="btn btn-default" onclick="$Core.CoverPhoto.reposition.cancel()">{_p var='cancel'}</a>
            <div id="save_reposition_cover" class="btn btn-primary" data-cmd="profile.reposition_cover_save">{_p var='save'}</div>
        </div>
    </div>
	{/if}
		...
		<div class="profiles_extra_info">
            ...
            {if (isset($aUser.is_friend_request) && $aUser.is_friend_request)}
                <div>
                    ...
                    {if $aUser.is_friend_request == 2 && !$aUser.is_ignore_request}
