...
<div class="attachment-row" id="js_attachment_id_{$aRow.attachment_id}">
    <div id="js_attachment_id_content_{$aRow.attachment_id}" class="item-outer">
        <div class="attachment-image {if !$aRow.is_image && !$aRow.is_video}attachment-image-icon{/if}">
            {if $aRow.is_image && $aRow.destination}
            ...
            {elseif $aRow.is_video && $aRow.video_image_destination}
        ...
        <div class="attachment-body">
            ...
            {else}
                <div class="attachment-row-title">
                    ...
                    {else}
                        <a href="{url link='attachment.download' url=''$aRow.url''}" class="attachment_row_link no_ajax_link item-title">{$aRow.file_name}</a> <span class="item-info">{$aRow.using}</span>
                    {/if}
                </div>
            {/if}
