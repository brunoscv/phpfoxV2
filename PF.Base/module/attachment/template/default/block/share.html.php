        ...
        <div class="global_attachment_header">
            <div class="global_attachment_manage">
                <a class="border_radius_4" role="button" onclick="$Core.Attachment.toggleAttachmentForm(this)" id="attachment-toggle-button">
                    <span class="ico ico-paperclip-alt"></span> <span class="item-label-text">{_p var='attachments'}</span> <span class="attachment-counter">{if !empty($aForms.total_attachment)}({$aForms.total_attachment}){else}(0){/if}</span>
            ...
            <div class="js_attachment_list_holder">
                <div class="attachment_holder">
                    <div class="attachment_list">
                        ...
                        {module name='attachment.list' sType=$aAttachmentShare.type iItemId=$aAttachmentShare.edit_id attachment_no_header=true bGetAttachmentList=true editorId=$id}
                        {/if}
