 ...
 * @author  		phpFox LLC
 * @package 		Phpfox
 * @version 		$Id: entry.html.php 5616 2013-04-10 07:54:55Z phpFox LLC $
 */
	...
	{/if}
		...
		<div style="margin:5px 0px 0px 10px;">
			<div class="extra_info" style="font-size:8pt;">
				{$aNotification.time_stamp|date:'core.global_update_time'} - <a href="{$aNotification.link}">{_p var='view'}</a> &middot; <a href="#" onclick="$.ajaxCall('notification.hide', 'id={$aNotification.notification_id}'); return false;">{_p var='hide'}</a>
			</div>
		</div>
		{/if}
	{if $aNotification.user_id > 0 || !empty($aNotification.item_image)}
