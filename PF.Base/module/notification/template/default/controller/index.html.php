...
{else}
    ...
    <div id="js_notification_holder" class="core-notification-listing-container">
        {if !PHPFOX_IS_AJAX}
        ...
        {foreach from=$aNotifications name=notifications key=sDate item=aSubNotifications}
            ...
            {foreach from=$aSubNotifications item=aNotification}
                <li id="js_notification_{$aNotification.notification_id}" class="js_notification_{$aNotification.notification_id} all-notification-item {if !$aNotification.is_read} is_new{/if}">
