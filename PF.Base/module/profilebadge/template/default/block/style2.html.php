...
echo 'background-repeat: no-repeat;"><div style="position:relative;max-width:250px;width:98%;top:80px;left:2%;width:55px;height:55px;"><a href="'.$aGroup_url .'" target=_new><img src="'.$avatarpath.'" width=100% style="padding:3px;
;-moz-box-shadow: 0px 0px 4px #cccccc; -webkit-box-shadow: 0px 0px 4px #cccccc; box-shadow: 0px 0px 4px #cccccc;background-color:#ffffff;-moz-border-radius: 5px; -webkit-border-radius: 5px; -khtml-border-radius: 5px; border-radius: 5px;"></a></div><div style="position:relative;top:28px;left:70px;text-align:left;max-width:250px;width:98%;height:30%;text-shadow: black 0.1em 0.1em 0.2em;max-height:30px;overflow:hidden;line-height: 1cm;"><font size=4 color='.Phpfox::getParam('profilebadge.fontcolorname').' face=arial>'.$aRow['full_name'].'</font></div>';

if (Phpfox::getParam('profilebadge.sitename')){
echo '<div style="position:relative;text-align:left;max-width:250px;width:100%;top:28px;left:72px;"><font size=2 color='.Phpfox::getParam('profilebadge.fontcolorsite').' face=arial>' . Phpfox::getPhrase('profilebadge.visit') . '<br></font><b><a href="'.Phpfox::getParam('core.path').'" target=_new><font size=2 color='.Phpfox::getParam('profilebadge.fontcolorsite').' face=arial>'.Phpfox::getParam('core.site_title').'</font></a></b></div>';
}
