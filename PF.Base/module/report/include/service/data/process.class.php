 ...
 * @version 		$Id: process.class.php 2525 2011-04-13 18:03:20Z phpFox LLC $
 */
    ...
    public function process($iId)
    {
        ...
        if (isset($aReport['item_id'])) {
            ...
            Phpfox::getLib('mail')->to($aReport['user_id'])
                ->subject('Your report is processed')
                ->message(['Your report for item {link} is processed', ['link' => $link]])
                ->send();
