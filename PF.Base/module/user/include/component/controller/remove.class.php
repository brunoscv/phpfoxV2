...
class User_Component_Controller_Remove extends Phpfox_Component
{
    ...
    public function process()
    {
        ...
        if (Phpfox::isModule('friend')) {
            list(, $aShowFriends) = Phpfox::getService('friend')->get('friend.is_page = 0 AND friend.user_id = ' . Phpfox::getUserId() . ' AND ' . Phpfox_Database::instance()->isNotNull('user_image'), 'RAND()', 0, 3);
