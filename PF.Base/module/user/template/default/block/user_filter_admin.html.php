        ...
        <div class="panel-body">
            <div class="clearfix row">
                ...
                <div id="js_admincp_search_options" class="hide">
                    ...
                    {assign var='sFormGroupClass' value='col-sm-3 js_core_init_selectize_form_group'}
                ...
                <div class="pull-right">
                        <span class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a href="javascript:void(0);" onclick="tb_show('{_p('import_settings')}', $.ajaxBox('user.importUsers', 'height=300&width=600')); return false;">{_p var='import_user_from_csv'}</a>
                                </li>
                                <li>
                    ...
                    <button class="btn btn-info" onclick="tb_show('{_p('exports_settings')}', $.ajaxBox('user.exportUsers', 'height=300&width=600')); return false;">{_p var='export_users'}</button>
                </div>
                {/if}
            </div>
        </div>
