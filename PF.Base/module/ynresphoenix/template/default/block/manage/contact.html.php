...
<div class="panel-default">
    <div class="panel-heading">
        <div class="panel-title" style="position: relative">
            {_p('Contacts')}
            <button onclick="window.location.href='{url link='admincp.ynresphoenix.add'}{$sType}'" style="position: absolute; right: 0; bottom: -6px;" class="btn btn-success btn-sm">{_p('Add Contact')}</button>
        </div>
    </div>
</div>
{if count($aPageItems)}
                    ...
                    <td class="t_center">
                        ...
                        <div class="link_menu">
                            <ul>
                                ...
                                <li><a href="{url link='admincp.ynresphoenix.manage'}{$sType}?delete={$aItem.item_id}" class="sJsConfirm" data-message="{_p('Are you sure you want to delete this blog?')}">{_p('Delete')}</a></li>
                            </ul>
                        </div>
                    </td>
                    <td>
