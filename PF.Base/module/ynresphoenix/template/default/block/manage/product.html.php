...
<div class="panel-default">
    <div class="panel-heading">
        <div class="panel-title" style="position: relative">
            {_p('Products')}
            {if count($aPageItems) < 10}
            <button onclick="window.location.href='{url link='admincp.ynresphoenix.add'}{$sType}'" style="position: absolute; right: 0; bottom: -6px;" class="btn btn-success btn-sm">{_p('Add Product')}</button>
            {/if}
        </div>
    </div>
</div>
    ...
    <div class="panel panel-default" id="ynresphoenix_manage_pages">
                    ...
                    <td class="t_center">
                        ...
                        <div class="link_menu">
                            <ul>
                                ...
                                <li><a href="{url link='admincp.ynresphoenix.manage'}{$sType}?delete={$aItem.item_id}" class="sJsConfirm" data-message="{_p('Are you sure you want to delete this reason?')}">{_p('Delete')}</a></li>
                            </ul>
                        </div>
                    </td>
                    <td>
        ...
        <div class="panel-footer">
            <div class="extra_info" style="float: left;">
                <span>{_p('You can have maximum 10 products')}</span>
                <br/>
