...
<ul class="dropdown-menu dropdown-menu-right">
    ...
    {if !empty($feed_entry_be) && (defined('PHPFOX_FEED_CAN_DELETE') || (Phpfox::getUserParam('feed.can_delete_own_feed') && $aFeed.user_id == Phpfox::getUserId()) || Phpfox::getUserParam('feed.can_delete_other_feeds') || (!defined('PHPFOX_IS_PAGES_VIEW') && !empty($aFeed.parent_user_id) && (int)$aFeed.parent_user_id === Phpfox::getUserId()))}
