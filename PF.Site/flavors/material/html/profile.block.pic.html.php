	...
	<div class="profiles_banner_bg">
        ...
        {/if}
            <div class="cover" id="cover_bg_container">
                ...
                {if !empty($aCoverPhoto.destination)}
                    {img server_id=$aCoverPhoto.server_id path='photo.url_photo' file=$aCoverPhoto.destination suffix='' class="visible-lg cover_photo"}
        ...
        <div class="cover-reposition-actions">
            ...
            <div id="save_reposition_cover" class="btn btn-primary" onclick="$Core.CoverPhoto.reposition.save()">{_p var='save'}</div>
        </div>
    </div>
    {/if}
