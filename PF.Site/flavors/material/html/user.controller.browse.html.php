...
{else}
	...
	{if isset($highlightUsers) && !$bOldWay}
        ...
        <div class="friend_request_reload ajax" data-url="{url link='user.browse' recommend=1}"></div>
        {/if}
	<div class="friend_request_reload ajax" data-url="{url link='user.browse' featured=1}"></div>
	{else}
		{if $aUsers}
		{if !PHPFOX_IS_AJAX}
