        ...
        <form class="form" method="post" action="javascript:void(0);" id="js_activity_feed_edit_form" enctype="multipart/form-data">
            ...
            <div class="activity_feed_form_holder">
                ...
                {if isset($bLoadCheckIn) && $bLoadCheckIn == true}
                    ...
                    <div id="js_location_feedback{$aForms.feed_id}" class="js_location_feedback{$aForms.feed_id} feed-location-info {if !empty($aForms.location_name)}active{/if}">
            ...
            <div class="activity_feed_form_button" style="display: block">
                ...
                {if $bLoadCheckIn}
                    <div id="js_location_input{$aForms.feed_id}">
                        <a class="pr-4" href="#" title="{_p var='close'}" onclick="$Core.FeedPlace.cancelCheckIn({$iFeedId}, true); return false;"><i class="ico ico-eye-alt-blocked"></i></a>
                        <a class="" href="#" title="{_p var='remove_checkin'}" onclick="$Core.FeedPlace.cancelCheckIn({$iFeedId}); return false;">
