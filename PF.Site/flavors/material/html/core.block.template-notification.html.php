...
<ul class="user-sticky-bar-items">
    ...
    {else}
    {plugin call='core.template_notification_list_start'}
    ...
    <li class="settings-dropdown" id="hd-cof">
        ...
        <ul class="dropdown-menu dropdown-menu-right dont-unbind">
            <li class="background-cover-block">
                ...
                <div class="profile-info pl-2 pr-7 py-1">
                    {if !empty($aCurentUser.full_name)}
                    <div class="fullname">{$aCurentUser.full_name|clean}</div>
                    {/if}
                    {if !empty($aCurentUser.title)}
                    <div class="memebership-level">{_p var=$aCurentUser.title}</div>
                    {/if}
                </div>
                <div class="edit-profile">
                    <a href="{url link='user.profile'}" title="{_p var='edit_profile'}" class="no_ajax s-4 btn-primary btn-gradient">
                        <i class="ico ico-pencilline-o"></i>
                    </a>
                </div>
            </li>
