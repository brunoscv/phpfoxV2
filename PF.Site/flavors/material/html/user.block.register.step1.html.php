...
<div id="js_register_step1">
    ...
    {if Phpfox::getParam('user.reenter_email_on_signup')}
        <div class="form-group">
            ...
            <div id="js_confirm_email_error" class="p_top_8" style="display:none;"><div class="error_message">{_p var='email_s_do_not_match'}</div></div>
        </div>
        <div class="separate"></div>
    {/if}
    ...
    <div class="form-group">
        {if isset($bIsPosted)}
            <input class="form-control" placeholder="{_p var='password'}" type="password" name="val[password]" id="register_password" value="{value type='input' id='password'}" size="30" autocomplete="off" />
        {else}
            <input class="form-control" placeholder="{_p var='password'}" type="password" name="val[password]" id="register_password" value="" size="30" autocomplete="off" />
        {/if}
    </div>
    {if Phpfox::getParam('user.signup_repeat_password')}
        <div class="form-group">
            <input class="form-control" placeholder="{_p var='repassword'}" type="password" name="val[repassword]" id="register_repassword" value="" size="30" autocomplete="off" />
        </div>
    {/if}
