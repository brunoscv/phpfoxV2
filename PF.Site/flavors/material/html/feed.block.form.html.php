      ...
      <div class="activity_feed_form_button">
        <div class="activity_feed_form_button_status_info">
          ...
          {if $bLoadCheckIn}
              <div id="js_location_input">
                  <a class="pr-4" href="#" title="{_p var='close'}" onclick="$Core.FeedPlace.cancelCheckIn('', true); return false;"><i class="fa fa-eye-slash"></i></a>
                  <a class="" href="#" title="{_p var='remove_checkin'}" onclick="$Core.FeedPlace.cancelCheckIn(''); return false;">
        ...
        <div class="activity_feed_form_button_position">
          ...
          <div class="activity_feed_form_button_position_button">
            <button type="submit" value="{_p var='share'}"  id="activity_feed_submit" class="button btn btn-gradient btn-primary"><span class="ico ico-paperplane hide"></span><span>{_p var='share'}</span></button>
          </div>
          {if isset($aFeedCallback.module)}
          {else}
