...
class VkontakteController extends Phpfox_Component
{
    public function process()
    {
        ...
        $adapterId = $this->request()->get('adapter') ? $this->request()->get('adapter') : 'Vkontakte';
        ...
        try {
            ...
            $aVals["data"]["user_name"] = $aVals["displayName"];
            $aVals["data"]["displayName"] = $aVals["data"]["firstName"]." ".$aVals["data"]["lastName"];
