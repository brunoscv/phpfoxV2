...
class WindowsliveController extends Phpfox_Component
{
    public function process()
    {
        ...
        $adapterId = $this->request()->get('adapter') ? $this->request()->get('adapter') : 'WindowsLive';
        ...
        try {
            ...
            $aVals["data"]["profileURL"] = $userProfile->profileURL;
            ...
            } elseif (\Phpfox::getCookie("is_import")) {
                //IMPORT CONTACT HOOK
                (($sPlugin = Phpfox_Plugin::get('socialconnect.import_contacts')) ? eval($sPlugin) : false);
            }  else {
