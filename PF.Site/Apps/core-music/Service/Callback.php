...
class Callback extends \Phpfox_Service
{
    ...
    {
        if (!Phpfox::getService('groups')->hasPerm($aPage['page_id'], 'music.share_music') || (!Phpfox::getUserParam('music.can_upload_music_public') && !Phpfox::getUserParam('music.can_add_music_album'))) {
            return null;
        }
        $aMenu = [];
        if (Phpfox::getUserParam('music.can_upload_music_public')) {
