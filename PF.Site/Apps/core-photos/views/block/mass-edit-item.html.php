<div class="item-inner">
    <div class="photo_edit_wrapper">
            ...
            {if Phpfox::getService('photo.category')->hasCategories()}
                <div class="item-categories dropdown hide {if $aForms.category_list != ''}success{/if}">
                    ...
                    <div class="item-categories-inner dropdown-menu pf-dropdown-not-hide-photo">
                        ...
                        <div class="form-group item-category js_core_init_selectize_form_group">
        ...
        {if $aForms.album_id == '0' && $aForms.group_id == '0' && Phpfox::isModule('privacy')}
    ...
    <div class="form-group item-title page hide">
        <input placeholder="{_p var='Title'}" title="{_p var='Title'}" id="title" type="text" name="val{if isset($aForms.photo_id)}[{$aForms.photo_id}]{/if}[title]" value="{if isset($aForms.title)}{$aForms.title|clean}{else}{value type='input' id='title'}{/if}" size="30" maxlength="150" onfocus="this.select();" class="form-control" required/>
    </div>
