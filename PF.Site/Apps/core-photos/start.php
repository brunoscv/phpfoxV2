...
Phpfox_Module::instance()
    ...
    ->addComponentNames('block', [
        ...
        'photo.featured-album'  => Block\FeaturedAlbumBlock::class,
        'photo.sponsored-album' => Block\SponsoredAlbumBlock::class
    ]);
...
group('/photo', function () {
    ...
    route('/admincp/category/order', function () {
        ...
        Phpfox::getLib('cache')->removeGroup('photo_category');
        return true;
    });
    ...
    route('/message', function () {
        ...
        if ($bMassEdit && $iTotal > 0) {
            ...
            } else if (!empty($sModule) && Phpfox::isModule($sModule)) {
