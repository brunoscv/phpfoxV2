...
<tr id="js_comment_{$aComment.comment_id}">
    ...
    <td class="t_center w40">
        ...
        <div class="link_menu">
            <ul>
                <li><a href="#" onclick="$Core.jsConfirm({l}{r}, function(){l}$.ajaxCall('comment.moderateSpam', 'id={$aComment.comment_id}&amp;action=approve&amp;inacp={if isset($bIsCommentAdminPanel)}1{else}0{/if}'); return false;{r},function(){l}{r});" >{_p var='approve'}</a></li>
                <li><a href="#" onclick="$Core.jsConfirm({l}{r}, function(){l}$.ajaxCall('comment.moderateSpam', 'id={$aComment.comment_id}&amp;action=deny&amp;inacp={if isset($bIsCommentAdminPanel)}1{else}0{/if}'); return false;{r},function(){l}{r});">{_p var='deny'}</a></li>
            </ul>
        </div>
    </td>
    <td class="w180">
