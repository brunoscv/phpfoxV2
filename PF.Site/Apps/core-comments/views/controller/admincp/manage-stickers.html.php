...
<form method="post" id="manage_sticker_set" action="{url link='admincp.comment.manage-stickers'}">
    <div class="panel panel-default">
                        ...
                        <td class="t_center w60">
                            ...
                            <div class="link_menu">
                                <ul>
                                        ...
                                        {if !$aSet.is_default}
                                            {if !$aSet.view_only}
                                                <li><a href="{url link='admincp.comment.manage-stickers' delete=$aSet.set_id}" class="sJsConfirm">{_p var='delete'}</a></li>
                                            {/if}
        ...
        <div class="panel-footer">
            <input type="submit" name="val[delete_selected]" id="delete_selected" disabled value="{_p('delete_selected')}" class="sJsConfirm sJsCheckBoxButton btn btn-danger disabled"/>
        </div>
    </div>
</form>
{/if}
