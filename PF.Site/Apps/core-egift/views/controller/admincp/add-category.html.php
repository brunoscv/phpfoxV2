    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <span class="js_item_active item_is_active" onclick="$('#availableSince, #availableUntil').hide();">
                    <input class='form-control' type="radio" name="val[do_schedule]" value="1" {value type='radio' id='do_schedule' default='1'}/> {_p var='yes'}
                </span>
                    <span class="js_item_active item_is_not_active" onclick="$('#availableSince, #availableUntil').show();">
            ...
            <div class="form-group" id="availableSince" style="{if empty($aForms.do_schedule)}display: none;{/if}">
                <div class="form-inline">
                    ...
                    <div class="form-group">
                        ...
                        {select_date prefix='start_' start_year=$aForms.start_year end_year='+10' field_separator=' / ' field_order='MDY' default_all=true time_separator='event.time_separator'}
                    </div>
                    <div class="form-group">
