...
class FrameController extends Phpfox_Component
{
    public function process()
    {
        if (($aVals = $this->request()->getArray('val'))) {
            if (($this->request()->get('widget_id') ? Phpfox::getService('groups.process')->addWidget($this->request()->get('val'),$this->request()->get('widget_id')
                ...
                Phpfox::addMessage(_p($this->request()->get('widget_id') ? 'groups_update_widget' : 'groups_add_widget'),'success', true);
            } else {
