...
class AddController extends Phpfox_Component
{
    ...
    public function process()
    {
        ...
        if ($iEditId && ($aPage = \Phpfox::getService('groups')->getForEdit($iEditId))) {
            $bIsEdit = true;
            ...
            $this->template()->assign([
                ...
                'aPageMenus' => Phpfox::getService('groups')->_getMenu($aPage, Phpfox::getService('groups')->getUrl($aPage['page_id'], $aPage['title'],
