...
<div class="groups-profile-banner">
    <div class="profiles_banner {if $aCoverPhoto !== false}has_cover{/if}">
        <div class="profiles_banner_bg">
            ...
            {/if}
                <div class="cover" id="cover_bg_container">
                    {if $aCoverPhoto}
                        {img server_id=$aCoverPhoto.server_id path='photo.url_photo' file=$aCoverPhoto.destination suffix='' title=$aCoverPhoto.title class="visible-lg cover_photo"}
        ...
        {if (\Phpfox::getUserParam('groups.can_edit_all_groups', 0) || $aPage.is_admin) && user('pf_group_add_cover_photo')}
