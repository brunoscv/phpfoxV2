...
Phpfox_Module::instance()
    ...
    ->addComponentNames('block', [
        ...
        'pages.featured' => Apps\Core_Pages\Block\Featured::class,
        'pages.sponsored' => Apps\Core_Pages\Block\Sponsored::class,
        'pages.reassign-owner' => Apps\Core_Pages\Block\ReassignOwner::class,
        'pages.page-feed' => Apps\Core_Pages\Block\PageFeedBlock::class
    ])
