...
class Objects
{
    ...
    public function save($type, $values, $sub_type = '')
    {
        ...
        switch ($type) {
            ...
            case 'icon':
                ...
                return Phpfox::getLib('assets')->getAssetUrl($url);
            ...
            case 'banners':
                ...
                Phpfox::getLib('storage')->get()->putFile($path);

                return str_replace(PHPFOX_DS, '/', str_replace(PHPFOX_DIR_SITE, home() . 'PF.Site/', $path));
    ...
    public function logo_url($type = 'logos', $bSkipCache = false)
    {
        ...
        $logo = get_from_cache('flavor/' . $type . '/' . $this->id, function () use ($type) {
            ...
            $logo = str_replace(PHPFOX_DIR_SITE, Phpfox::getParam('core.path_actual') . 'PF.Site/', $logo);
